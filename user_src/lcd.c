...
void LCDTestDisplay(void)
{
    ...
    if(Display_key_SW3 != Count_key_SW3)
    {
        ...
        display_map_xy(52,45,5,8,char_Small+('C' - ' ')*5);
        k = i;j = k + 3;
        for(i = i;i < j;i++)                  //RXBRE
    ...
    if(LCDUpdateIDFlag == 1)
    {
        ...
        switch (DATA_Packet_Contro_buf){
            case 0x14: break; //stop+login
            case 0x40: break; //自动送信
            case 0x01: break; //VENT
            case 0x02: display_map_58_6(70,63,5,"CLOSE");break;
            case 0x04: display_map_58_6(70,63,5,"STOP ");break;
            case 0x08: display_map_58_6(70,63,5,"OPEN ");break;
            case 0x0C: break; //open+stop
            case 0x06: break; //close+stop
            case 0x0A: break; //close+OPEN
            case 0x09: break; //vent+OPEN
            case 0x03: break; //vent+close
            default: break;
...
/*  unsigned char i,x;
  ...
  if(lcd_rssi!=m){
    ...
    display_map_xy(86+24,0,5,8,char_Small+0x44*5);      //显示dBm
